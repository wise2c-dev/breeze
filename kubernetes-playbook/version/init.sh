...
docker run --rm --name=kubeadm-version wisecloud/kubeadm-version:v1.11.8 kubeadm config images list --kubernetes-version ${k8s_version} --feature-gates=CoreDNS=false > ${path}/k8s-images-list.txt
